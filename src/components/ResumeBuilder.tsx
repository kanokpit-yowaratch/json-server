					...
					<div className="flex border-b border-slate-200 dark:border-slate-800 px-2 sm:px-4 bg-white dark:bg-slate-950">
						<button
							...
							<span className="truncate">
								...
								<span className="hidden sm:inline">
									1. แก้ไขข้อมูล<span className="hidden lg:inline"> (Content)</span>
								</span>
							</span>
						</button>
						...
						<button
							...
							<span className="truncate">
								...
								<span className="hidden sm:inline">
									2. ตกแต่งสไตล์<span className="hidden lg:inline"> (Design)</span>
								</span>
							</span>
						</button>
						...
						<button
							...
							<span className="truncate">
								...
								<span className="hidden sm:inline">
									3. คู่มือตำแหน่งงาน<span className="hidden lg:inline"> (Guide)</span>
								</span>
							</span>
						</button>
					</div>
